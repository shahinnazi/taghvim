...
import com.shahin.irani.AgeWidget
import com.shahin.irani.BuildConfig
import com.shahin.irani.DEFAULT_SELECTED_WIDGET_BACKGROUND_COLOR
import com.shahin.irani.DEFAULT_SELECTED_WIDGET_TEXT_COLOR
...
import com.shahin.irani.NON_HOLIDAYS_EVENTS_KEY
import com.shahin.irani.OTHER_CALENDARS_KEY
import com.shahin.irani.OWGHAT_KEY
import com.shahin.irani.OWGHAT_LOCATION_KEY
import com.shahin.irani.PREF_SELECTED_DATE_AGE_WIDGET
import com.shahin.irani.PREF_SELECTED_DATE_AGE_WIDGET_START
import com.shahin.irani.PREF_SELECTED_WIDGET_BACKGROUND_COLOR
import com.shahin.irani.PREF_SELECTED_WIDGET_TEXT_COLOR
import com.shahin.irani.PREF_TITLE_AGE_WIDGET
import com.shahin.irani.R
import com.shahin.irani.Widget1x1
import com.shahin.irani.Widget2x2
import com.shahin.irani.Widget4x1
import com.shahin.irani.Widget4x2
import com.shahin.irani.WidgetMap
import com.shahin.irani.WidgetMonth
import com.shahin.irani.WidgetMonthView
import com.shahin.irani.WidgetMoon
import com.shahin.irani.WidgetSchedule
import com.shahin.irani.WidgetSunView
import com.shahin.irani.entities.CalendarEvent
import com.shahin.irani.entities.Clock
import com.shahin.irani.entities.DeviceCalendarEventsStore
import com.shahin.irani.entities.EventsStore
...
import com.shahin.irani.global.isCenterAlignWidgets
import com.shahin.irani.global.isForcedIranTimeEnabled
import com.shahin.irani.global.isHighTextContrastEnabled
import com.shahin.irani.global.isNotifyDate
import com.shahin.irani.global.isNotifyDateOnLockScreen
import com.shahin.irani.global.isShowDeviceCalendarEvents
import com.shahin.irani.global.isShowWeekOfYearEnabled
import com.shahin.irani.global.isTalkBackEnabled
import com.shahin.irani.global.isWidgetClock
...
import com.shahin.irani.global.mainCalendarDigits
import com.shahin.irani.global.prefersWidgetsDynamicColorsFlow
import com.shahin.irani.global.secondaryCalendar
import com.shahin.irani.global.spacedComma
import com.shahin.irani.global.whatToShowOnWidgets
import com.shahin.irani.global.widgetTransparency
import com.shahin.irani.service.BroadcastReceivers
import com.shahin.irani.service.ScheduleWidgetService
import com.shahin.irani.service.widgetWidthCellKey
import com.shahin.irani.ui.MainActivity
import com.shahin.irani.ui.astronomy.AstronomyState
import com.shahin.irani.ui.calendar.calendarpager.DayPainter
import com.shahin.irani.ui.calendar.calendarpager.MonthColors
import com.shahin.irani.ui.calendar.calendarpager.renderMonthWidget
import com.shahin.irani.ui.calendar.eventTextColor
import com.shahin.irani.ui.calendar.sortEvents
import com.shahin.irani.ui.calendar.times.SunView
import com.shahin.irani.ui.calendar.times.SunViewColors
import com.shahin.irani.ui.common.SolarDraw
import com.shahin.irani.ui.map.MapDraw
import com.shahin.irani.ui.map.MapType
import com.shahin.irani.ui.resumeToken
import com.shahin.irani.ui.settings.agewidget.AgeWidgetConfigureActivity
import com.shahin.irani.ui.utils.dp
import com.shahin.irani.ui.utils.isLandscape
import com.shahin.irani.ui.utils.isRtl
import com.shahin.irani.ui.utils.isSystemInDarkTheme
