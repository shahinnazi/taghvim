package com.shahin.irani.global
...
import com.shahin.irani.DEFAULT_AM
import com.shahin.irani.DEFAULT_ASCENDING_ATHAN_VOLUME
import com.shahin.irani.DEFAULT_ATHAN_VIBRATION
import com.shahin.irani.DEFAULT_AZERI_ALTERNATIVE_PERSIAN_MONTHS
import com.shahin.irani.DEFAULT_CITY
import com.shahin.irani.DEFAULT_DREAM_NOISE
import com.shahin.irani.DEFAULT_EASTERN_GREGORIAN_ARABIC_MONTHS
import com.shahin.irani.DEFAULT_ENGLISH_GREGORIAN_PERSIAN_MONTHS
import com.shahin.irani.DEFAULT_HIGH_LATITUDES_METHOD
import com.shahin.irani.DEFAULT_HOLIDAY
import com.shahin.irani.DEFAULT_IRAN_TIME
import com.shahin.irani.DEFAULT_ISLAMIC_OFFSET
import com.shahin.irani.DEFAULT_LOCAL_DIGITS
import com.shahin.irani.DEFAULT_NOTIFY_DATE
import com.shahin.irani.DEFAULT_NOTIFY_DATE_LOCK_SCREEN
import com.shahin.irani.DEFAULT_PM
import com.shahin.irani.DEFAULT_PRAY_TIME_METHOD
import com.shahin.irani.DEFAULT_RED_HOLIDAYS
import com.shahin.irani.DEFAULT_SECONDARY_CALENDAR_IN_TABLE
import com.shahin.irani.DEFAULT_THEME_GRADIENT
import com.shahin.irani.DEFAULT_VAZIR_ENABLED
import com.shahin.irani.DEFAULT_WALLPAPER_AUTOMATIC
import com.shahin.irani.DEFAULT_WALLPAPER_DARK
import com.shahin.irani.DEFAULT_WIDGET_CLOCK
import com.shahin.irani.DEFAULT_WIDGET_CUSTOMIZATIONS
import com.shahin.irani.DEFAULT_WIDGET_IN_24
import com.shahin.irani.DEFAULT_WIDGET_TRANSPARENCY
import com.shahin.irani.IRAN_TIMEZONE_ID
import com.shahin.irani.PREF_ALTITUDE
import com.shahin.irani.PREF_APP_LANGUAGE
import com.shahin.irani.PREF_ASCENDING_ATHAN_VOLUME
import com.shahin.irani.PREF_ASR_HANAFI_JURISTIC
import com.shahin.irani.PREF_ASTRONOMICAL_FEATURES
import com.shahin.irani.PREF_ATHAN_NAME
import com.shahin.irani.PREF_ATHAN_VIBRATION
import com.shahin.irani.PREF_AZERI_ALTERNATIVE_PERSIAN_MONTHS
import com.shahin.irani.PREF_CALENDARS_IDS_AS_HOLIDAY
import com.shahin.irani.PREF_CALENDARS_IDS_TO_EXCLUDE
import com.shahin.irani.PREF_CENTER_ALIGN_WIDGETS
import com.shahin.irani.PREF_DREAM_NOISE
import com.shahin.irani.PREF_EASTERN_GREGORIAN_ARABIC_MONTHS
import com.shahin.irani.PREF_ENGLISH_GREGORIAN_PERSIAN_MONTHS
import com.shahin.irani.PREF_GEOCODED_CITYNAME
import com.shahin.irani.PREF_HIGH_LATITUDES_METHOD
import com.shahin.irani.PREF_IRAN_TIME
import com.shahin.irani.PREF_ISLAMIC_OFFSET
...
import com.shahin.irani.PREF_MIDNIGHT_METHOD
import com.shahin.irani.PREF_NOTIFICATION_ATHAN
import com.shahin.irani.PREF_NOTIFY_DATE
import com.shahin.irani.PREF_NOTIFY_DATE_LOCK_SCREEN
import com.shahin.irani.PREF_NUMERICAL_DATE_PREFERRED
import com.shahin.irani.PREF_OTHER_CALENDARS_KEY
import com.shahin.irani.PREF_PRAY_TIME_METHOD
import com.shahin.irani.PREF_RED_HOLIDAYS
import com.shahin.irani.PREF_SECONDARY_CALENDAR_IN_TABLE
...
import com.shahin.irani.PREF_SHOW_DEVICE_CALENDAR_EVENTS
import com.shahin.irani.PREF_SHOW_WEEK_OF_YEAR_NUMBER
import com.shahin.irani.PREF_SWIPE_DOWN_ACTION
import com.shahin.irani.PREF_SWIPE_UP_ACTION
import com.shahin.irani.PREF_SYSTEM_DARK_THEME
import com.shahin.irani.PREF_SYSTEM_LIGHT_THEME
import com.shahin.irani.PREF_THEME
import com.shahin.irani.PREF_THEME_GRADIENT
import com.shahin.irani.PREF_VAZIR_ENABLED
...
import com.shahin.irani.PREF_WHAT_TO_SHOW_WIDGETS
import com.shahin.irani.PREF_WIDGETS_PREFER_SYSTEM_COLORS
import com.shahin.irani.PREF_WIDGET_CLOCK
import com.shahin.irani.PREF_WIDGET_IN_24
import com.shahin.irani.PREF_WIDGET_TRANSPARENCY
import com.shahin.irani.R
import com.shahin.irani.entities.Calendar
...
import com.shahin.irani.ui.calendar.SwipeDownAction
import com.shahin.irani.ui.calendar.SwipeUpAction
import com.shahin.irani.ui.theme.Theme
import com.shahin.irani.utils.applyAppLanguage
import com.shahin.irani.utils.enableHighLatitudesConfiguration
import com.shahin.irani.utils.getJdnOrNull
import com.shahin.irani.utils.isIslamicOffsetExpired
import com.shahin.irani.utils.logException
import com.shahin.irani.utils.preferences
import com.shahin.irani.utils.scheduleAlarms
import com.shahin.irani.utils.splitFilterNotEmpty
